...
import hashlib
from flask import Flask, render_template, jsonify, request, redirect, url_for, certifi
...
MONGODB_URI="mongodb+srv://testuser:testuser@cluster0.zbwu59l.mongodb.net/?retryWrites=true&w=majority, tlsCAFile=certifi.where()"
DB_NAME='dbsparta'

MONGODB_CONNECTION_STRING = "mongodb+srv://testuser:testuser@cluster0.zbwu59l.mongodb.net/?retryWrites=true&w=majority, tlsCAFile=certifi.where()"
...
def sign_up():
    ...
    doc = {
        ...
        "profile_pic": "",
        "profile_pic_real": "profile_pics/profile.png",
        "profile_info": ""
    }
